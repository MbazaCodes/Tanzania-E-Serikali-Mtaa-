...
const UPDATABLE_FIELDS = [
  'first_name', 'middle_name', 'last_name', 'gender', 'sex', 'nationality', 'country_of_citizenship',
  'nida_number', 'id_type', 'id_number', 'phone', 'email', 'photo_url', 'is_diaspora', 'country_of_residence',
  'passport_number', 'region', 'district', 'ward', 'street', 'birth_region', 'birth_district',
  'mtaa_executive_officer', 'ward_councillor', 'ward_chairperson', 'assigned_region', 'assigned_district',
  'date_of_birth', 'place_of_birth', 'marital_status', 'occupation', 'education_level', 'alternative_phone',
  'email_address', 'alternative_email', 'house_number', 'postal_code', 'landmark', 'emergency_contact_name',
  'emergency_contact_phone', 'emergency_contact_relation', 'employee_id', 'department', 'position',
  'employment_date', 'blood_group', 'disability_status', 'religious_affiliation', 'tribe', 'last_login',
  'account_status', 'email_verified', 'phone_verified', 'voter_id_number', 'driving_license_number',
  'city_of_residence', 'diaspora_region', 'diaspora_district', 'diaspora_ward'
];
          ...
          {activeTab === 'documents' && (
            ...
            >
              ...
              <AnimatePresence>
                {showDocumentUpload && (
                  ...
                  >
                    ...
                    {/* File Upload */}
                    <div className="space-y-2">
                      <label htmlFor="document-upload" className="text-xs font-bold text-stone-500 uppercase tracking-wider">
              ...
              {DOCUMENT_CATEGORIES.map(category => {
                ...
                const CategoryIcon = category.value === 'id' ? CreditCard : category.value === 'certificate' ? Award : FileText;
